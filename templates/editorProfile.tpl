...
<style>
.emp-profile{max-width:980px;margin:0 auto 3rem}.emp-card{display:flex;gap:1.5rem;align-items:flex-start;border:1px solid currentColor;border-color:rgba(0,0,0,.18);border-radius:.5rem;padding:1.5rem}.emp-photo,.emp-photo-fallback{width:150px;height:150px;border-radius:50%;object-fit:cover;flex:0 0 150px;background:rgba(0,0,0,.06)}.emp-photo-fallback{display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:700}.emp-title{margin:.1rem 0 .5rem}.emp-roles{display:flex;flex-wrap:wrap;gap:.4rem;margin:.25rem 0 .75rem}.emp-role{border:1px solid currentColor;border-radius:999px;padding:.25rem .65rem;font-size:.9rem}.emp-affiliation{font-weight:600;margin:.5rem 0}.emp-links{display:flex;flex-wrap:wrap;gap:.5rem;margin:1rem 0}.emp-links a,.emp-back{display:inline-block;text-decoration:none;border:1px solid currentColor;border-radius:999px;padding:.35rem .75rem}.emp-links a:hover,.emp-links a:focus,.emp-back:hover,.emp-back:focus{text-decoration:underline}.emp-bio{margin-top:1.5rem;line-height:1.6}.emp-bio h2{font-size:1.25rem}.emp-bio-content{overflow-wrap:anywhere}.emp-back-wrap{margin:1.5rem 0}@media(max-width:650px){.emp-card{flex-direction:column;text-align:center;align-items:center}.emp-links,.emp-roles{justify-content:center}}
</style>
